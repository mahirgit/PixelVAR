...
- SSD-1B practical diffusion was evaluated on `64` images.
...
| SSD-1B practical diffusion | 64 | 87.8128 | 196.9628 | 0.007124 | 0.092097 | 0.8125 | 0.0312 | 0.9375 | 0.6719 | 0.9219 | 0.0469 | 0.3935 |
...
| SSD-1B practical diffusion | Generic SDXL-family practical baseline people expect. | Weak/moderate: some recognizable sprites, many lineup/crop/multi-character failures. | Prompt-sensitive text-to-image model; not sprite-dataset-trained. | Keep as generic practical comparison. |
...
practical external visual baseline, but the 256-image run confirms that it does
not close the gap: FID is `154.0150` versus PixelVAR's matching `46.4794`, and
coverage is `0.0508` versus PixelVAR's matching `0.8906`.
