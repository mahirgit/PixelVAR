...
This runs the public sprite-specific SDXL LoRA baseline at the current primary
external-generator scale, then normalizes outputs to the same 32x32 PixelVAR
palette protocol:
...
```powershell
$env:PYTHONIOENCODING='utf-8'; $env:PYTHONUTF8='1'
New-Item -ItemType Directory -Force -Path reports\external_eval\main_vs_pokemon_sprite_lora_256 | Out-Null
modal volume get pixelvar-outputs /external_eval/main_vs_pokemon_sprite_lora_256/evaluation_report.md reports/external_eval/main_vs_pokemon_sprite_lora_256/evaluation_report.md --force
modal volume get pixelvar-outputs /external_eval/main_vs_pokemon_sprite_lora_256/metrics.csv reports/external_eval/main_vs_pokemon_sprite_lora_256/metrics.csv --force
